...
module.exports = function () {
    ...
    router.post('/adduser2', function (req, res) {
        ...
        connection.query(stmt, [userid, password, salt, name, pnumber], function (error, results, fields) {
            if (error) throw error;
    ...
    router.post('/adduser3', function (req, res) {
        ...
        hasher({
            ...
            const stmt = 'INSERT INTO user (userid, password, salt,name, pnumber) VALUES (?,?,?,?,?)';
            console.log("err: ",222);
            connection.query(stmt, [userid, hash, salt, name, pnumber], function (error, results, fields) {
                if (error) throw error;
